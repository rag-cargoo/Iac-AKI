...
- `make 01-lab-docker-swarm-setup_env` 또는 실습 디렉터리에서 `make setup_env`를 실행하면 `labs/01-lab-docker-swarm/src/run/common/setup_env.sh`가 bastion/manager/worker의 fingerprint를 자동으로 재등록해 줍니다.
