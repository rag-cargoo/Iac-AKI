...
ENV_DIR="$PROJECT_ROOT/src/terraform/envs/$TERRAFORM_ENVIRONMENT"

echo "--- Running setup_env.sh ---"
source "$PROJECT_ROOT/src/run/common/setup_env.sh"
...
ANSIBLE_INVENTORY_PLUGIN="$PROJECT_ROOT/src/ansible/inventory_plugins/swarm.py"
