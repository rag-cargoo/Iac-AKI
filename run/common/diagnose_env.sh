...
ENV_DIR="$PROJECT_ROOT/src/iac/terraform/envs/$TERRAFORM_ENVIRONMENT"

echo "--- Running setup_env.sh ---"
source "$PROJECT_ROOT/run/common/setup_env.sh"
echo "--- setup_env.sh finished ---"
echo ""

echo "--- Environment Variables after setup_env.sh ---"
...
ANSIBLE_INVENTORY_PLUGIN="$PROJECT_ROOT/src/iac/ansible/inventory_plugins/swarm.py"
